...
### Instructions
To generate figures using R scripts, it is necessary first to construct and validate the prediction models. This can be done by running the following scripts:

1. **Model Construction**: `construct_models.R`
2. **Internal Validation**: `internal_validation.R`
3. **External Validation**: `external_validation_of_models.R`
